    ...
    return switch (expression) {
      ...
      case VarAssignment(String name, Expr expr, boolean declaration, int lineNumber) -> {
          ...
          if(!declaration && env.lookupOrDefault(name, null) == null) {
              throw new Failure("no variable named " + name + " defined at line " + lineNumber);
          }
          ...
          public Object invoke(Object receiver, Object... args) {
            // check the arguments length
              if(parameters.size() != args.length) {
                  throw new Failure("invalid number of arguments (arguments " + args.length + " vs parameters " + parameters.size() + " at line " + lineNumber);
              }
